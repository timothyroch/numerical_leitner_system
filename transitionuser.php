...
<head>
    ...
    <title>Visiting <?php echo $username ?></title>
...
<body>
    ...
    <script>
        ...
        function fadeOutAndRedirect() {
            ...
            setTimeout(() => {
                window.location.href = 'visit.php?A9R4V2k8T7L1X5M3Q=<?php echo base64_encode($userid); ?>&J6N8W1F9C2P7D4L0Z=<?php echo urlencode(base64_encode($username)); ?>';
            }, 2400); // Redirect after a delay to allow lightspeed effect
        }
